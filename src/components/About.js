  ...
  return (
    <div className="about">
      ...
      <p className="description">
          Over the course of ten years in software developing, I have attained significant experience coding with a variety of programming languages, working directly with corporate leadership and clients.
      </p>
      <p className="description">
          Working at KKday, I have five years of experience with systems architecture and full-stack web development. I have been responsible for developing, maintaining and trouble-shooting 12 websites serving five million+ users monthly. I have also recently gained experience in DevOps, providing solutions in programming, database technology, and operating systems.
      </p>
    </div>
  );
};
